  ...
  return (
    <div className="max-w-3xl">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-muted mb-2">Prioritas sumber:</p>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2 text-sm text-muted leading-relaxed">
          <li>
            Lab praktik pada CyberPath hanya menautkan ke sandbox, CTF, atau lingkungan yang
            secara eksplisit mengizinkan pengujian (mis. PortSwigger Web Security Academy,
            Hack The Box, TryHackMe).
          </li>
          <li>
            CyberPath tidak menyediakan panduan menyerang target nyata tanpa izin.
          </li>
          <li>
            Sebelum menguji keamanan sistem apa pun, selalu dapatkan otorisasi tertulis.
            Pelajari konsep <em>responsible disclosure</em>.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2 text-sm text-muted leading-relaxed">
          <li>
            <strong className="text-foreground">Professional Certification</strong> — credential
            industri yang memerlukan asesmen formal dan memiliki aturan sertifikasi.
          </li>
          <li>
            <strong className="text-foreground">Course Certificate / Statement of Participation</strong>{' '}
            — bukti menyelesaikan kursus, bukan sertifikasi profesional.
          </li>
          <li>
            <strong className="text-foreground">Digital Badge</strong> — badge digital untuk
            pencapaian tertentu.
          </li>
          <li>
            <strong className="text-foreground">Training only</strong> — materi gratis, tetapi
            tidak ada credential gratis yang terverifikasi.
          </li>
        </ul>
        <p className="text-sm text-muted mt-3">
          Banyak kursus gratis di internet, tetapi ujian, lab, atau sertifikatnya berbayar.
          CyberPath selalu menampilkan bagian <em>Yang gratis</em> dan{' '}
          <em>Kemungkinan biaya tambahan</em> secara terpisah.
        </p>
      </section>
