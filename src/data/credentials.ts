...
export const credentials: Credential[] = [
  ...
  },
  {
    ...
    officialUrl: 'https://www.fortinet.com/nse-training',
    type: 'professional-certification',
    status: 'active',
    difficulty: 'beginner',
    courseFree: true,
    credentialFree: true,
    costRange: 'Gratis (USD 0) — training NSE self-paced',
    examFormat: 'Ujian online; NSE 1 tanpa ujian, NSE 2–3 memiliki ujian',
  ...
  },
  {
    ...
    credentialFree: false,
    examFree: false,
    costRange: 'Gratis (USD 0) untuk training; exam sertifikasi berbayar',
